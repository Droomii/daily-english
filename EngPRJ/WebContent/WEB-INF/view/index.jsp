	...
	<div class="row match-height">
		...
		<div class="col-lg-12 col-md-12">
			<div class="card" onclick="location.href='/today/todayQuiz.do'" >
				<div class="card-body">
					<h4 class="card-title text-center mb-0" style="font-size:1.5rem;"><i class="la la-book" style="font-size:2rem;vertical-align:center;"></i><span style="font-size:2rem">오늘의 퀴즈</span></h4>
				</div>
			</div>
		</div>
		<div class="col-6">
		...
		<div class="col-lg-12 col-md-12">
			<div class="card" onclick="location.href='/today/todayNews.do'" >
				<div class="card-body">
